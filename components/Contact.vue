<template>
  <section
    ...
    class="bg-white flex flex-col-reverse lg:flex-row items-center gap-10 lg:gap-4 p-10 lg:pl-20 text-lg"
  >
    <div
    ...
    >
      ...
      <div class="flex flex-row items-center justify-center gap-10">
        <a
          ...
          target="_blank"
          class="w-12 lg:w-14 duration-300 hover:-translate-y-1.5 flex flex-col justify-center"
        >
          <svg
            fill="#007EBA"
        ...
        <a
          ...
          target="_blank"
          class="w-12 lg:w-14 duration-300 hover:-translate-y-1.5"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 496 512"
