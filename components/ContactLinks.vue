<template>
  <div class="flex flex-col sm:flex-row items-center justify-center lg:justify-normal gap-5">
...
import MenuDownloadResume from '~/components/MenuDownloadResume.vue'
</script>
