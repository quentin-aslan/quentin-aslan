<template>
  <div
    class="duration-300 hover:-translate-y-1.5 flex flex-col gap-2 items-center cursor-pointer"
    aria-haspopup="true"
    ...
    items: [
      {
        ...
        icon: 'pi pi-download',
        url: '/resume/CV_ASLAN_QUENTIN_EN.pdf',
        target: '_blank',
      },
      {
        label: '🇫🇷 Télécharger en Français',
        icon: 'pi pi-download',
        url: '/resume/CV_ASLAN_QUENTIN_FR.pdf',
        target: '_blank',
      },
    ],
  },
