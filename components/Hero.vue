<template>
  <section class="relative container mx-auto max-w-full lg:w-3/5 lg:h-screen pt-40 mb-20 text-gray-700">
      ...
      <div class="flex flex-col lg:flex-row-reverse gap-8 lg:gap-20 items-center">
        ...
        <div class="animate-fade-in-left-slow flex flex-col text-center lg:text-left gap-2 w-4/5">
          ...
          <div class="flex flex-row items-center justify-center lg:justify-normal gap-5">
            <a href="https://www.linkedin.com/in/quentin-aslan/?locale=en_US" target="_blank" class="w-10 duration-300 hover:-translate-y-1.5 flex flex-col justify-center">
              <svg fill="#00549A" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
          ...
          <span class="text-gray-600" title="My Username on Linkedin and Github are quentin-aslan">@quentin-aslan</span>
